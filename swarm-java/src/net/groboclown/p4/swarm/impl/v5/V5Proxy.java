...
package net.groboclown.p4.swarm.impl.v5;

import net.groboclown.p4.swarm.SwarmClient;
import net.groboclown.p4.swarm.SwarmConfig;
import net.groboclown.p4.swarm.client.api.V5Api;
...
public class V5Proxy extends AbstractProxyClient {
    private final V5Api api;

    public V5Proxy(SwarmConfig config) {
        super(config);
        this.api = new V5Api(createClient());
    }
