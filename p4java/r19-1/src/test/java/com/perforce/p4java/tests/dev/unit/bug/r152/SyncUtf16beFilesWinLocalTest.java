...
public class SyncUtf16beFilesWinLocalTest extends P4JavaRshTestCase {

	@ClassRule
	public static SimpleServerRule p4d = new SimpleServerRule("r16.1", SyncUtf16beFilesWinLocalTest.class.getSimpleName());
