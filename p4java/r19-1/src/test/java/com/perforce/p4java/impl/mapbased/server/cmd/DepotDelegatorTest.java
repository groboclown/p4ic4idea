...
public class DepotDelegatorTest extends AbstractP4JavaUnitTest {
    ...
    public void testDeleteDepot() throws P4JavaException {
        when(server.execMapCmdList(eq(DEPOT.toString()), argThat(DELETE_MATCHER), eq((Map<String,Object>)null)))
                .thenReturn(buildDepotDeletedMap());
        String result = depotDelegator.deleteDepot(TEST_DEPOT);
        verify(server).execMapCmdList(eq(DEPOT.toString()), argThat(DELETE_MATCHER), eq((Map<String,Object>)null));
    ...
    public void testGetDepot() throws P4JavaException {
        when(server.execMapCmdList(eq(DEPOT.toString()), argThat(GET_MATCHER), eq((Map<String,Object>)null)))
                .thenReturn(buildGetMap());
        IDepot result = depotDelegator.getDepot(TEST_DEPOT);
        verify(server).execMapCmdList(eq(DEPOT.toString()), argThat(GET_MATCHER), eq((Map<String,Object>)null));
