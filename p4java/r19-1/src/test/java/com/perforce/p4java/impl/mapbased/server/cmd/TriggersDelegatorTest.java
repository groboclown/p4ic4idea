...
public class TriggersDelegatorTest extends AbstractP4JavaUnitTest {
    ...
    public void beforeEach() {
        ...
        entryList = new ArrayList<ITriggerEntry>();
    ...
    public class TestCreateTriggerEntries {
        ...
        public void beforeEach() throws Exception {
            ...
            when(server.execMapCmdList(eq(TRIGGERS.toString()), eq(createCmdArguments), any(Map.class)))
    ...
    public class TestGetTriggerEntries {
        ...
        @Before
        public void beforeEach() throws Exception {
            when(server.execMapCmdList(eq(TRIGGERS.toString()), eq(getCmdArguments), eq((Map<String, Object>)null)))
                    .thenReturn(resultMaps);
        }
    ...
    public class TestUpdateTriggerEntries {
        ...
        public void beforeEach() throws Exception {
            resultMaps = buildCreateTriggerEntries();
            when(server.execMapCmdList(eq(TRIGGERS.toString()), eq(updateCmdArguments), any(Map.class)))
                    .thenReturn(resultMaps);
        }
