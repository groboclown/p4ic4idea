...
public class P4HistoryProvider implements VcsHistoryProvider {
    ...
    private final P4DiffFromHistoryHandler diffHandler;

    public P4HistoryProvider(Project project) {
        this.project = project;
        diffHandler = new P4DiffFromHistoryHandler();
    }
    ...
    private static class P4DiffFromHistoryHandler implements DiffFromHistoryHandler {
        ...
        @Override
        public void showDiffForTwo(@NotNull Project project, @NotNull FilePath filePath, @NotNull VcsFileRevision revision1, @NotNull VcsFileRevision revision2) {
