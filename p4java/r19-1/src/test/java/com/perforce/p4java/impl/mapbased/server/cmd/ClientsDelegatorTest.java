    ...
    public class TestGetClients {
        ...
        public class WhenGetClientsOptionsGiven {
            ...
            public void beforeEach() throws Exception {
                ...
                when(server.execMapCmdList(eq(CLIENTS.toString()), eq(cmdArguments), (Map<String,Object>)any()))
        ...
        public class WhenUserNameNameFilterAndMaxResultsGiven {
            ...
            private void throwExpectedException(Class<? extends Throwable> toBeThrown)
                ...
                doThrow(toBeThrown)
                        .when(server)
                        .execMapCmdList(eq(CLIENTS.toString()), eq(expectedCmdArgs), eq((Map<String,Object>)null));
