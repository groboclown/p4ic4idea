...
public class StreamClientsTest extends P4JavaRshTestCase {
    ...
    @ClassRule
    public static SimpleServerRule p4d = new SimpleServerRule("r16.1", StreamClientsTest.class.getSimpleName());
