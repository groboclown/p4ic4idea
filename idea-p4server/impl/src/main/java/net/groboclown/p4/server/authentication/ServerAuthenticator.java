...
import net.groboclown.p4.server.impl.config.ServerConfig;
import net.groboclown.p4.server.api.exceptions.old.TodoMoveMeExceptionUtil;
import net.groboclown.p4.server.api.exceptions.old.LoginRequiresPasswordException;
import net.groboclown.p4.server.api.exceptions.P4AccessException;
import net.groboclown.p4.server.api.exceptions.P4ApiException;
import net.groboclown.p4.server.api.exceptions.P4InvalidPluginConfigException;
import net.groboclown.p4.server.api.exceptions.P4SSLStrengthException;
import net.groboclown.p4.server.api.exceptions.P4LoginException;
import net.groboclown.p4.server.api.exceptions.P4LoginRequiresPasswordException;
import net.groboclown.p4.server.api.exceptions.P4SSLException;
import net.groboclown.p4.server.api.exceptions.P4VcsConnectionException;
...
public class ServerAuthenticator {
    ...
    public AuthenticationStatus createStatusFor(@NotNull URISyntaxException e) {
        return statBuilder(new P4InvalidPluginConfigException(e))
                .notConnected()
                .clientSetupProblem()
                .create();
    }
    ...
    private static <T> ExecResult<T> runExec(@NotNull ExecFunc<T> exec, @NotNull IOptionsServer server) {
        try {
            ...
            return new ExecResult<T>(statBuilder(new P4SSLStrengthException(e))
                    .notConnected()
                    .notLoggedIn()
                    .create());
            ...
            if (cause instanceof ConfigException) {
                return new ExecResult<T>(statBuilder(new P4InvalidPluginConfigException((ConfigException) cause))
                        .notConnected()
                        .clientSetupProblem()
                        .notLoggedIn()
                        .create());
            ...
            if (TodoMoveMeExceptionUtil.isLoginUnnecessary(e)) {
            ...
            if (TodoMoveMeExceptionUtil.isLoginPasswordProblem(e)) {
            ...
            if (TodoMoveMeExceptionUtil.isSessionExpiredProblem(e)) {
            ...
            if (TodoMoveMeExceptionUtil.isLoginRequiresPasswordProblem(e)) {
