...
public class P4CheckinEnvironment implements CheckinEnvironment, CommitExecutor {
    ...
    public RefreshableOnComponent createAdditionalOptionsPanel(
            @NotNull CheckinProjectPanel panel, @NotNull PairConsumer<Object, Object> additionalDataConsumer) {
    ...
    public CommitSession createCommitSession() {
        ...
        return new CommitSession() {
            ...
            @Nullable
            @Override
            public JComponent getAdditionalConfigurationUI(@NotNull Collection<Change> changes, String commitMessage) {
