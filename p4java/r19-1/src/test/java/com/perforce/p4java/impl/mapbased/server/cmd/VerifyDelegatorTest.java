...
public class VerifyDelegatorTest extends AbstractP4JavaUnitTest {
    ...
    public void beforeEach() throws Exception {
        ...
        when(server.execMapCmdList(eq(VERIFY.toString()), eq(CMD_ARGUMENTS),
     ...
     */
    @Test
    public void shouldReturnEmptyListWhenNoErrorNoDepotPath() throws Exception {
    ...
    /**
     * Expected return empty verified fileSpecs when has depot file but is
     * contains desc
     *
     * @throws Exception
     */
    @Test
    public void shouldReturnEmptyListWhenNoErrorHasDepotPathButContainsDescField()
            throws Exception {
    ...
    /**
     * Expected return non empty verified fileSpecs when has depot file and is
     * contain desc
     *
     * @throws Exception
     */
    ...
    public void shouldReturnNonEmptyListThatDontHaveAnyErrorDontHaveDepotPathAndIsNotContainsDescField()
        ...
        shouldReturnNonEmptyList(new UnitTestGiven() {
            @Override
    ...
    /**
     * Expected return non empty verified 'error' fileSpecs when error message
     * is real error message FIXME: server.handleFileErrorStr()
     *
     * @throws Exception
     */
    ...
    /**
     * Expected return non empty verified 'info' fileSpecs when error message is
     * info message FIXME: server.handleFileErrorStr()
     *
     * @throws Exception
     */
    @SuppressWarnings("deprecation")
