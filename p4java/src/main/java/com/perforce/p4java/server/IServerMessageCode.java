...
public interface IServerMessageCode {
     ...
     * Text: "==== < none > - %depotFile%%depotRev% ===="
     */
    int DIFF_2DATA_RIGHT_PRE_04_1 = 423;
     ...
     */
    int DIFF_2DATA_UNIFIED_DIFFER = 471;
