...
public class JobDelegatorTest extends AbstractP4JavaUnitTest {
    ...
    public void testJobGetEmpty() throws P4JavaException {
        when(server.execMapCmdList(eq(JOB.toString()), argThat(EMPTY_MATCHER), eq((Map<String,Object>)null)))
                .thenReturn(buildEmptyGetResultMap());
        IJob job = jobDelegator.getJob("");
        verify(server).execMapCmdList(eq(JOB.toString()), argThat(EMPTY_MATCHER), eq((Map<String,Object>)null));
    ...
    public void testJobDeleteConnectionException() throws P4JavaException {
        when(server.execMapCmdList(eq(JOB.toString()), argThat(DELETE_MATCHER), eq((Map<String, Object>)null)))
    ...
    public void testJobCreate() throws P4JavaException {
        ...
        verify(server).execMapCmdList(eq(JOB.toString()), argThat(CREATE_MATCHER),
                eq(CREATE_FIELD_MAP));
        verify(server).execMapCmdList(eq(JOB.toString()), argThat(GET_MATCHER), eq((Map<String, Object>)null));
        assertJob(job);
    }
    ...
    public void testJobDelete() throws P4JavaException {
        ...
        verify(server).execMapCmdList(eq(JOB.toString()), argThat(DELETE_MATCHER), eq((Map<String, Object>)null));
