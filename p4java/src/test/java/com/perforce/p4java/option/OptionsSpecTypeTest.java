...
public class OptionsSpecTypeTest {
  ...
  public void of() throws Exception {
    ...
    assertThrows(OptionsException.class, () -> OptionsSpecType.of("unknown"));
  }
  ...
  public void getP4CommandOptionFiled() throws Exception {
    assertThrows(OptionsException.class, () -> OptionsSpecType.IntOption.getP4CommandOptionField(null, "p", "12L"));
    ...
    assertThrows(OptionsException.class, () -> OptionsSpecType.LongOption.getP4CommandOptionField(null, "p", "12L"));
    ...
    assertThrows(OptionsException.class, () -> OptionsSpecType.BoolOption.getP4CommandOptionField(null, "p", "12L"));
    ...
    assertThrows(OptionsException.class, () -> OptionsSpecType.BoolOption.getP4CommandOptionField(null, "p", 0));
    assertThrows(OptionsException.class, () -> OptionsSpecType.BoolOption.getP4CommandOptionField(null, "p", 1));
    assertThrows(OptionsException.class, () -> OptionsSpecType.BoolOption.getP4CommandOptionField(null, "p", "not valid boolean value"));
    ...
    assertThat(empty, is(""));
    assertThrows(OptionsException.class, () -> OptionsSpecType.StringOption.getP4CommandOptionField("haha", "p", "f"));
    ...
    assertThrows(OptionsException.class, () -> OptionsSpecType.StringArrayOption.getP4CommandOptionFields(null, "f", new Object[]{"a", 3}));
