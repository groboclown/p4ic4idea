...
/**
 * Test in-memory concurrent IPv6 fingerprints handling.
 */
@Jobs({ "job061060", "job061048" })
@TestId("Dev131_IPv6InMemoryFingerprintsHelperConcurrencyTest")
@Ignore("Until we have an ipv6 compliant network")
public class IPv6InMemoryFingerprintsHelperConcurrencyTest extends P4JavaTestCase {
