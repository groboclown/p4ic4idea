...
public class ErrorActionAnswerImpl<S> implements P4CommandRunner.ActionAnswer<S> {
    private final P4CommandRunner.ServerResultException error;

    public ErrorActionAnswerImpl(@NotNull P4CommandRunner.ServerResultException error) {
        this.error = error;
    }
