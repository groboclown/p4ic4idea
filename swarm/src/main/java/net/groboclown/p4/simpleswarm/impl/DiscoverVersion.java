...
public class DiscoverVersion {
    private static BasicRequest REQUEST = new BasicRequest();
    ...
    public static SwarmConfig discoverVersion(SwarmConfig config)
        ...
        BasicResponse ret = REQUEST.get(config, "version", null);
    ...
    private static SwarmConfig checkForVersion1(SwarmConfig config)
        ...
        BasicResponse response = REQUEST.get(config, "version", null);
