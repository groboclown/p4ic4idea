...
public class UserPreferencesPanel {
    ...
    boolean getPreferRevisionsForFiles() {
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        openForEditInCheckBox.setToolTipText(ResourceBundle.getBundle("net/groboclown/idea/p4ic/P4Bundle")
                .getString("user.prefs.edit_in_separate_thread.tooltip"));
        panel1.add(openForEditInCheckBox,
