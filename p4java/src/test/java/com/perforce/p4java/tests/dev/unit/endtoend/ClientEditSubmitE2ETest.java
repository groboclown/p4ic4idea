...
public class ClientEditSubmitE2ETest extends P4JavaRshTestCase {
    ...
    private void verifyFileSpecInfo(List<IFileSpec> fSpecs, FileSpecOpStatus expOpStatus, String expMsg) {
        ...
        assertTrue("The FileSpec's Msg did not contain the expected string.", doesMessageContainText(msg, expMsg));
            ...
            for (IFileSpec fileSpec : newFSList) {
                if (fileSpec != null) {
                    ...
                    if (fSpecOpStatus == FileSpecOpStatus.VALID) {
                        ...
                        if (isMessageStringNumeric(fSpecMsg)) {
