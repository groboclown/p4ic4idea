 ...
 */
@TestId("UnimplementedErrorTest")
public class UnimplementedErrorTest extends BaseThrowableTestHelper {
	...
	return new UnimplementedError(cause);
    }
	...
	return new UnimplementedError(message, cause);
    }
