...
public class StatDelegatorTest extends AbstractP4JavaUnitTest {
    ...
    public void testStatConnectionException() throws P4JavaException {
        when(server.execMapCmdList(eq(ISTAT.toString()), argThat(STAT_MATCHER), eq((Map<String, Object>)null)))
    ...
    public void testStatNoOptions() throws P4JavaException {
        ...
        verify(server).execMapCmdList(eq(ISTAT.toString()), argThat(STAT_MATCHER), eq((Map<String, Object>)null));
    }
    ...
    public void testStatOptions() throws P4JavaException {
        when(server.execMapCmdList(eq(ISTAT.toString()), argThat(STAT_OPT_MATCHER), eq((Map<String, Object>)null)))
                .thenReturn(buildValidResultMap());
        ...
        verify(server).execMapCmdList(eq(ISTAT.toString()), argThat(STAT_OPT_MATCHER), eq((Map<String, Object>)null));
    }
