...
import net.groboclown.p4.server.cache.local.IgnoreFiles;
import net.groboclown.p4.server.connection.ServerConnection.CreateUpdate;
import net.groboclown.p4.server.util.DepotFilePath;
...
public class ClientCacheManager {
    ...
    public ServerUpdateAction revertFilesIfUnchangedOnline(@NotNull final Collection<FilePath> files,
            int changelistId, @NotNull final Ref<MessageResult<List<FilePath>>> ret) {
