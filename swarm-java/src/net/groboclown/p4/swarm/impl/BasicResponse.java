...
public class BasicResponse {
    ...
    public BasicResponse(SwarmVersion version, HttpResponse response)
            throws IOException {
    ...
    public BasicResponse(SwarmVersion version, int code, String reason, String body) {
        this.version = version;
        this.code = code;
        this.reason = reason;
        this.body = body;
    ...
    public <T> T getBodyAs(Class<T> typeOfT) {
        return buildGson().fromJson(body, typeOfT);
    }
