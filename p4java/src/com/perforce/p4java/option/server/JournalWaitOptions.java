 ...
 */
public class JournalWaitOptions extends Options {
	
	/**
	 * Options: -i
	 */
	public static final String OPTIONS_SPECS = "b:i";
	
	/**
	 * If true, turn off journal-wait. This allows the application to specify
