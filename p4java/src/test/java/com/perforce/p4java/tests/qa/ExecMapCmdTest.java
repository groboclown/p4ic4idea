...
public class ExecMapCmdTest {
    ...
    public void acceptableCommand() throws Throwable {
        ...
        IServerMessage msg = server2.getErrorOrInfoStr(results[0]);
        assertThat("bad message", msg, nullValue());

        String msgStr = server2.getInfoStr(results[0]);
        assertThat("bad message", msgStr, nullValue());
    ...
    public void badCommand() throws Throwable {
        ...
        IServerMessage msg = server2.getErrorOrInfoStr(results[0]);
        assertThat("bad message", msg, containsText("//depot/bar.txt - file(s) not on client."));
