...
import net.groboclown.p4.server.impl.config.ClientConfig;
import net.groboclown.p4.server.impl.config.ConfigProblem;
import net.groboclown.p4.server.impl.config.ConfigPropertiesUtil;
import net.groboclown.p4.server.impl.config.ServerConfig;
import net.groboclown.p4.server.api.exceptions.P4DisconnectedException;
import net.groboclown.p4.server.api.exceptions.P4InvalidClientException;
...
import net.groboclown.p4.server.api.exceptions.P4PasswordException;
import net.groboclown.p4.server.api.exceptions.P4SSLException;
import net.groboclown.p4.server.api.exceptions.P4SSLFingerprintException;
import net.groboclown.p4.server.api.exceptions.P4UnknownLoginException;
import net.groboclown.p4.server.api.exceptions.PasswordStoreException;
...
public class ConnectionUIConfiguration {
    ...
    public static ConfigProblem checkConnection(@NotNull ClientConfig clientConfig,
        ...
        } catch (P4InvalidPluginConfigException e) {
            return new ConfigProblem(null, e);
    ...
    private static class ErrorCollectorVisitor implements ServerRunner.ErrorVisitor {
        ...
        @Override
        public void configInvalid(P4InvalidPluginConfigException e)
                throws VcsException, CancellationException {
        ...
        public P4SSLException sslKeyStrengthError(SslHandshakeException e) {
            ...
            problems.add(e);
            return new P4SSLStrengthException(e);
        }
