...
public class StreamDelegatorTest extends AbstractP4JavaUnitTest {
    ...
    public class TestCreateStream {
        ...
        public void beforeEach() throws Exception {
            when(server.execMapCmdList(eq(STREAM.toString()), eq(createCmdArguments), any(Map.class)))
    ...
    public class TestGetStream {
        ...
        public class WhenStreamPathGiven {
            ...
            public void beforeEach() throws Exception {
                ...
                when(server.execMapCmdList(eq(STREAM.toString()), eq(getCmdArguments), eq((Map<String, Object>)null)))
                        .thenReturn(resultMaps);
            }
    ...
    public class TestUpdateStream {
        ...
        @Before
        public void beforeEach() throws Exception {
            when(server.execMapCmdList(eq(STREAM.toString()), eq(updateCmdArguments), any(Map.class)))
                    .thenReturn(resultMaps);
        }
    ...
    public class TestDeleteStream {
        ...
        public void beforeEach() throws Exception {
            ...
            when(server.execMapCmdList(eq(STREAM.toString()), eq(deleteCmdArguments), eq((Map<String, Object>)null)))
                    .thenReturn(resultMaps);
        }
