...
public class JobsDelegatorTest extends AbstractP4JavaUnitTest {
    ...
    public void testJobsOptConnectionException() throws P4JavaException {
        when(server.execMapCmdList(eq(JOBS.toString()), argThat(SIMPLE_MATCHER), eq((Map<String, Object>)null)))
    ...
    public void testJobsConnectionException() throws P4JavaException {
        when(server.execMapCmdList(eq(JOBS.toString()), argThat(PARAM_MATCHER), eq((Map<String, Object>)null)))
                .thenThrow(ConnectionException.class);
        List<IFileSpec> specs = FileSpecBuilder.makeFileSpecList(FILE_SPEC);
    ...
    public void testJobsOpt() throws P4JavaException {
        ...
        verify(server).execMapCmdList(eq(JOBS.toString()), argThat(SIMPLE_MATCHER), eq((Map<String, Object>)null));
        assertJobs(jobs);
    }
    ...
    public void testJobsSpecifiedOpt() throws P4JavaException {
        ...
        verify(server).execMapCmdList(eq(JOBS.toString()), argThat(PARAM_MATCHER), eq((Map<String, Object>)null));
        assertJobs(jobs);
    }
