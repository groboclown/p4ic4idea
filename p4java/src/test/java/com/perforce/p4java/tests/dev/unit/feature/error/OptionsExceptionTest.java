 ...
 */
@TestId("OptionsExceptionTest")
public class OptionsExceptionTest extends BaseThrowableTestHelper {
	...
	return new OptionsException(message);
    }
	...
	return new OptionsException(cause);
    }
	...
	return new OptionsException(message, cause);
    }
