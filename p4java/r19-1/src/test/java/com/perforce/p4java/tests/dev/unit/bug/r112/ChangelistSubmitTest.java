...
public class ChangelistSubmitTest extends P4JavaRshTestCase {
	...
	@ClassRule
    public static SimpleServerRule p4d = new SimpleServerRule("r16.1", ChangelistSubmitTest.class.getSimpleName());
	...
	public void setUp() {
		...
		try {
			...
			client = createClient(server, "changelistSubmitTestClient");
