...
public class P4ChangeListState implements CachedLocally {
    private int id;
    private String comment;
    private Set<P4ClientFileRev> added;
    private Set<P4ClientFileRev> deleted;
    private Set<P4ClientFileRev> edited;
    private Map<P4ClientFileRev, P4ClientFileRev> integrated;
    private Map<P4ClientFileRev, P4ClientFileRev> moved;
