    ...
    public class TestGetReviews {
        ...
        public class WhenFileSpecsGetReviewsOptionsGiven {
            ...
            public void beforeEach() throws ConnectionException, AccessException, RequestException {
                ...
                when(server.execMapCmdList(eq(REVIEWS.toString()), eq(cmdArguments),
                        (Map<String, Object>) any())).thenReturn(resultMaps);
            }

            /**
             * Expected return empty user summaries when command result maps is
             * null
             *
             * @throws Exception
             */
            ...
            public void shouldReturnEmptyUserSummariesWhenResultMapsIsNull() throws Exception {
                shouldReturnEmptyUserSummaries(new UnitTestGiven() {
                    ...
                    public void given() throws P4JavaException {
                        when(server.execMapCmdList(eq(REVIEWS.toString()), eq(cmdArguments),
                                (Map<String, Object>) any())).thenReturn(null);
                    }
                });
            }

            /**
             * Expected return empty user summaries when
             * InnerCatchBodyThrownUnexpectedException
             *
             * @throws Exception
             */
            @Test
            public void shouldReturnEmptyUserSummariesWhenInnerCatchBodyThrownUnexpectedException()
                    throws Exception {
                shouldReturnEmptyUserSummaries(new UnitTestGiven() {
                    @Override
                    public void given() throws P4JavaException {
            ...
            private void shouldReturnEmptyUserSummaries(UnitTestGiven unitTestGiven)
                    throws Exception {
                unitTestGiven.given();
                // when
            ...
            /**
             * Expected throws exception when inner 'handleErrorStr()' throws
             * exception
             *
             * @throws Exception
             */
            @Test
            public void shouldThrownExceptionWhenInnerHandleErrorStrCallThrowsIt()
                    throws Exception {
        ...
        public class WhenChangelistIdFileSpecsGiven {
            ...
            /**
             * Expected throws <code>ConnectionException</code> when inner
             * method call throws it
             *
             * @throws Exception
             */
            @Test
            ...
            /**
             * Expected throws <code>ConnectioAccessExceptionnException</code>
             * when inner method call throws it
             *
             * @throws Exception
             */
            @Test
            public void shouldThrownAccessExceptionWhenInnerMethodCallThrowsIt() throws Exception {
                expectedThrowsExceptions(AccessException.class, AccessException.class);
            }

            /**
             * Expected throws <code>RequestException</code> when inner method
             * call throws it
             *
             * @throws Exception
             */
            @Test
            public void shouldThrownRequestExceptionWhenInnerMethodCallThrowsIt() throws Exception {
            ...
            @SuppressWarnings("unchecked")
            private void expectedThrowsExceptions(Class<? extends P4JavaException> thrownException,
                ...
                // given
                doThrow(thrownException).when(server).execMapCmdList(eq(REVIEWS.toString()),
                        eq(cmdArguments), (Map<String, Object>) any());
