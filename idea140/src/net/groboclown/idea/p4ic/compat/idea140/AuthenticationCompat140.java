...
public class AuthenticationCompat140 implements AuthenticationCompat {
    @NotNull
    @Override
    public AuthenticationStore createAuthenticationStore(@Nullable Project project) {
        return new AuthenticationStore140(project);
    }

    private static class AuthenticationStore140 implements AuthenticationStore {
        private final Project project;
        private final MemoryPasswordSafe safe = new MemoryPasswordSafe();

        private AuthenticationStore140(@Nullable Project project) {
        ...
        public void clear(@NotNull String service, @NotNull String user) throws AuthenticationException {
            try {
                safe.removePassword(project, AuthenticationCompat140.class, key(service, user));
        ...
        public OneUseString get(@NotNull String service, @NotNull String user) throws AuthenticationException {
            try {
                String passwd = safe.getPassword(project, AuthenticationCompat140.class, key(service, user));
                if (passwd == null) {
                    return null;
                }
        ...
        public void set(@NotNull String service, @NotNull String user, @NotNull char[] authenticationToken)
            ...
            try {
                safe.storePassword(project, AuthenticationCompat140.class, key(service, user),
