...
public class RemoveJobFromChangelistAction extends AbstractAction implements P4CommandRunner.ClientAction<RemoveJobFromChangelistResult> {
    ...
    public RemoveJobFromChangelistAction(@NotNull P4ChangelistId changelistId, @NotNull P4Job job) {
        this(createActionId(RemoveJobFromChangelistAction.class), changelistId, job);
    }
