...
public class JournalWaitDelegatorTest extends AbstractP4JavaUnitTest {
    ...
    public void testWaitConnectionException() throws P4JavaException {
        when(server.execMapCmdList(eq(JOURNALWAIT.toString()), argThat(WAIT_MATCHER), eq((Map<String, Object>)null)))
    ...
    public void testWait() throws P4JavaException {
        ...
        journalWaitDelegator.journalWait(new JournalWaitOptions());
        verify(server).execMapCmdList(eq(JOURNALWAIT.toString()), argThat(WAIT_MATCHER), eq((Map<String, Object>)null));
    }
    ...
    public void testNoWait() throws P4JavaException {
        when(server.execMapCmdList(eq(JOURNALWAIT.toString()), argThat(NO_WAIT_MATCHER), eq((Map<String, Object>)null)))
                .thenReturn(new ArrayList<Map<String, Object>>());
