...
@Ignore("Ignoring this - An old 10.2 test where the required executable is not available")
public class ServerConfigureTest102 {
    ...
    public void setLongP4Name() {
        setConfigurable("P4NAME", "This is a very long name to test server"
    ...
    public void showAllNamedServer() {
        setConfigurable("P4NAME", "myServer");
