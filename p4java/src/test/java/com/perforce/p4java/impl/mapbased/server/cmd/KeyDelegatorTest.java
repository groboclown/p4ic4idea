...
public class KeyDelegatorTest {
    ...
    public void deleteShouldThrowIllegalArgumentExceptionWhenKeyNameIsBlank() throws Exception {
     ...
     */
    @Test(expected = IllegalArgumentException.class)
    public void getShouldThrowIllegalArgumentExceptionWhenKeyNameIsBlank() throws Exception {
