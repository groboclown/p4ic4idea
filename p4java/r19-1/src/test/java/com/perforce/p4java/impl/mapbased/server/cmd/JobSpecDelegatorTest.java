...
public class JobSpecDelegatorTest extends AbstractP4JavaUnitTest {
    ...
    public void testJobSpecConnectionException() throws P4JavaException {
        when(server.execMapCmdList(eq(JOBSPEC.toString()), argThat(SIMPLE_MATCHER), eq((Map<String, Object>)null)))
    ...
    public void testJobSpec() throws P4JavaException {
        ...
        verify(server).execMapCmdList(eq(JOBSPEC.toString()), argThat(SIMPLE_MATCHER), eq((Map<String, Object>)null));
