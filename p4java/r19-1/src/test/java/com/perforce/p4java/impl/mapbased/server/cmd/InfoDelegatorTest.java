...
public class InfoDelegatorTest extends AbstractP4JavaUnitTest {
    ...
    /** Example test value. */
    private static final String SERVER_ADDR = "eng-p4java-vm.das.perforce.com:20132";
    ...
    public void testInfoConnectionException() throws P4JavaException {
        when(server.execMapCmdList(eq(INFO.toString()), argThat(INFO_MATCHER), eq((Map<String, Object>)null)))
