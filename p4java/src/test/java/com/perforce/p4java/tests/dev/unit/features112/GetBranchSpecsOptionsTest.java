...
public class GetBranchSpecsOptionsTest extends P4JavaRshTestCase {

	IClient client = null;

    @ClassRule
    public static SimpleServerRule p4d = new SimpleServerRule("r16.1", GetBranchSpecsOptionsTest.class.getSimpleName());
